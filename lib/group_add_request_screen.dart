...
class _GroupAddRequestScreenState extends State<GroupAddRequestScreen> {
  ...
  Future<void> _submitRequest() async {
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Grup ekleme başvurunuz gönderildi.')));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Grup Ekleme Başvuru'),
      ),
      body: Padding(
          ...
          child: ListView(
            children: [
              DropdownButtonFormField<String>(
                decoration: InputDecoration(labelText: 'Grup Türü'),
              ...
              DropdownButtonFormField<String>(
                decoration: InputDecoration(labelText: 'Grup Kategorisi'),
              ...
              TextFormField(
                decoration: InputDecoration(labelText: 'Grup Davet Bağlantısı'),
